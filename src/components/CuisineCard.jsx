...
export default function CuisineCard({ restaurant }) {
  const { id, name, rating, cuisine, district, price, imageColor, tagline } = restaurant;
  ...
  return (
    ...
    >
      <Link to={`/dossier/${id}`} className="block">
        ...
        <div className="space-y-1">
          ...
          <p className="text-xs italic text-cool-ui/60 line-clamp-1 mb-2">{tagline}</p>
